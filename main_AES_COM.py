...
from shading import *
from train_AES import *
from models_AES import *

GPU_ID = 0
torch.cuda.set_device('cuda:' + str(GPU_ID))
...
def main():
    ...
    ASNL_G      = Unsuper_UNet_Split()
    if use_cuda:
        ASNL_G = ASNL_G.cuda()
        torch.cuda.manual_seed(seed_num)

    step_flag = 'Img1024_DPR_CelebA' # 1  apply pre_normal for refining
    model_dir = None   # 1
    # model_dir = '/media/hdr/oo/result/SinDecom/AE_S/Img1024_V_Syn_08_29/checkpoints/44__ASNL.pkl'
    model_dir='/home/hdr/autohdr/RefinedCodes/Gradient_ComData/4__ASNL.pkl'
